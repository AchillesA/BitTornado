    ...
    def encode(self, data, ctext):
        ...
        if isinstance(data, (list, tuple)):
            ...
            for key, data in sorted(ilist):
                ...
                #ctext.extend((str(len(key)).encode('utf-8'), b':',
                #              key.encode('utf-8')))
                self.encode(data, ctext)
            ctext.append(b'e')
            ...
            ctext.extend((str(len(string)).encode('utf-8'), b':', string))
        elif isinstance(data, (int, bool)):
            ctext.extend((b'i', str(data).encode('utf-8'), b'e'))
